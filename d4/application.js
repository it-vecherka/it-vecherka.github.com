...
(function() {
  $(function() {
    return $('footer').each(function() {
      return $('.before-footer').height("" + ($(this).height()) + "px");
    });
  });
